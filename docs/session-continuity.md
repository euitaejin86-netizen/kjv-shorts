...
| `scripts/2026-08-05-tree-of-life-01.json` → `out/2026-08-05-tree-of-life-01.mp4` | 창세기 3:24 / 요한계시록 22:14 (생명나무, 새 예루살렘 시리즈 중 첫 편) | **렌더링 완료, 업로드는 사용자 확인 대기 중.** 3장면 전환(막힘→나무→열림) 배경 사용. |
